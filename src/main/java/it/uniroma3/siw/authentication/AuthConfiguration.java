...
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET, "/", "/login", "/register", "/css/**", "/images/**", "favicon.ico","/utenteNonRegistrato/**","formRegisterUser.html").permitAll()
		...
		.and().exceptionHandling().accessDeniedPage("/utenteNonRegistrato/index")
